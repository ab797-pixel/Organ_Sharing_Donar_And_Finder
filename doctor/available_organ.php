...
<section id="admin_class" class="admin_class sections-bg">
      ...
      <div class="row">
        ...
        <div class="col-md-3">
        <a href="index.php?page=add_available_organ">
  ...
  <?php
   ...
   $doctor_id = $row['id'];
   $available_organ_query = "select * from available_organs where doctor_id = '$doctor_id' ";
  ...
  <tr>
    ...
    <td>
      <a href="index.php?page=available_organ&delete_id=<?php echo$id?>">Delete</a>
    </td>
  </tr>
  <?php
  $i++;
